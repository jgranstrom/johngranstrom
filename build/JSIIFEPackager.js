...
const concat = require('parcel-bundler/src/scope-hoisting/concat');
const urlJoin = require('parcel-bundler/src/utils/urlJoin');
const getExisting = require('parcel-bundler/src/utils/getExisting');
const walk = require('babylon-walk');
const babylon = require('@babel/parser');
const t = require('@babel/types');
const {getName, getIdentifier} = require('parcel-bundler/src/scope-hoisting/utils');

const helpers = getExisting(
  path.join(__dirname, '../node_modules/parcel-bundler/src/builtins/helpers.min.js'),
  path.join(__dirname, '../node_modules/parcel-bundler/src/builtins/helpers.js')
);

/**
 * This is a slight modification of the parcel concat packager to exclude unnecessary boilerplate
 */
class JSIIFEConcatPackager extends Packager {
  async start() {
  ...
  async addBundleLoader(bundleType, parentAsset, dynamic) {
    ...
    let bundleLoader = this.bundler.loadedAssets.get(
      require.resolve('parcel-bundler/src/builtins/bundle-loader')
    );
...
module.exports = JSIIFEConcatPackager;
